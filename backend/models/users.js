...
userSchema.statics.signup = async function(fullname, username, email, password, phoneNumber){
  //validation 
  if (!email || !password){
  ...
  const user = await this.create({fullname, username, email, password: hash, phoneNumber})
  return user
}
